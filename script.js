document.addEventListener("DOMContentLoaded", () => {
  ...
  if (serviceModal) {
    const serviceDetails = {
      ...
      copywriting: { number: "04", title: "Copywriting", summary: "Words that sound like you — only sharper.", whatsappMessage: "Hey Seven Circle, Is this service seperate or something that comes with packages?", items: ["Social captions", "Website copy", "Ad copy", "Product descriptions", "WhatsApp / email broadcast copy", "Brand voice & tone guide"] },
      ads: { number: "05", title: "Paid Advertising", summary: "Better reach. Smarter spend.", whatsappMessage: "Hey Seven Circle, I need some help with running meta ads and google ads for my business! when can we talk?", items: ["Meta Ads (Instagram / Facebook) setup & management", "Google Ads (Search / Display)", "Audience research & targeting", "Ad creative design", "A/B testing", "Budget optimization", "Monthly ad performance report"] },
      google: { number: "06", title: "Google Business Management", summary: "Be found when nearby matters most.", whatsappMessage: "Hey Seven Circle, I need my business to show up everytime people search! Can you help me?", items: ["Google Business Profile setup & optimization", "Review management & response", "Local citations & directory listings", "Keyword-optimized business description", "Photos & posts on your profile", "Local ranking tracking"] },
      whatsapp: { number: "07", title: "WhatsApp Automation", summary: "Make every enquiry easier to handle.", whatsappMessage: "Hey Seven Circle, I need to automate my whatsapp and change my Whatsapp to a lead converting machine. can you guys help me?", items: ["Auto-reply & greeting messages", "Product catalog setup", "Broadcast campaigns", "FAQ / order chatbot flow", "Lead capture & follow-up automation", "CRM / order integration"] },
      website: { number: "08", title: "Website Development", summary: "A digital home built to convert.", whatsappMessage: "Hey Seven Circle, I want to take the next step and create a website for my business. What are the package details to build a website?", items: ["Landing page design", "Full multi-page business website", "E-commerce store setup", "Mobile optimization", "Contact / lead forms", "Basic on-page SEO", "Hosting & maintenance"] },
      marketplace: { number: "09", title: "Marketplace Listings", summary: "Products that earn the click.", whatsappMessage: "Hey Seven Circle, can you help list our products in Amazon, Flipkart & other marketplaces?", items: ["Title & description optimization", "Keyword research", "Listing images / A+ content", "Category & pricing setup", "Inventory / catalog management", "Review & rating strategy", "Platforms: Amazon, Flipkart"] },
      ai: { number: "10", title: "AI Automation & Chatbots", summary: "More time back in your day.", whatsappMessage: "Hey Seven Circle, How does this AI Automation works? Can i have advantage on my business?", items: ["AI chatbot builder (website / WhatsApp)", "Appointment / booking automation", "Lead qualification automation", "Automated follow-ups & reminders", "Review-request automation", "Internal ops automation (invoicing, reporting)"] },
      "digital-card": { number: "11", title: "Digital Business Card", summary: "Your details, one tap away.", whatsappMessage: "Hey Seven Circle, I need a Digital Business Card, Can you share your works?", items: ["Digital card design (name, photo, contact)", "Tap-to-share / QR code setup", "Social & WhatsApp links integration", "Custom landing page for the card", "Editable / updatable anytime", "Analytics (who viewed / saved your card)"] },
      "app-development": { number: "12", title: "App Development", summary: "Turn your business idea into a powerful mobile experience.", whatsappMessage: "Hey Seven Circle, I need to develop an app for my Business! Can you guys Help me?", items: ["Android & iOS app development", "Customer & service apps", "Booking and appointment apps", "E-commerce apps", "Business utility apps", "App UI/UX design", "API & third-party integrations", "App maintenance and updates"] },
      "business-software": { number: "13", title: "Business Software Development", summary: "Less paperwork. Fewer repetitive tasks. More control over your business.", whatsappMessage: "Hey Seven Circle, Please share more details on Business Software Development. Can you guys create a software for my business operations?", items: ["Custom business management software", "Digital customer records", "Billing & invoicing systems", "Inventory management", "Staff & task management", "Booking & appointment systems", "Reports & dashboards", "Workflow automation", "Digital forms and document management", "WhatsApp / payment / API integrations"] },
      "local-seo-geo": { number: "14", title: "Local SEO & GEO", summary: "Get discovered on Google, Maps, and the next generation of AI search.", whatsappMessage: "Hey Seven Circle, I need more information about GEO, what is it? How can it help my business?", items: ["Local SEO", "Google Business Profile optimization", "Google Maps visibility", "Local keyword strategy", "On-page SEO", "Technical SEO", "Review & reputation signals", "Local citations", "Product SEO", "Content optimization", "AI / Generative Engine Optimization (GEO)", "Search visibility tracking & reporting"] },
